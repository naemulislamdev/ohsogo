...
Route::prefix('/admin')->as('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::controller(DiscountManageController::class)->prefix('/discount')->as('discount.')->middleware('module:product_management')->group(function () {
            ...
            Route::get('discount/flat', 'discountFlat')->name('flat');
            Route::get('discount/flat/create', 'discountFlatCreate')->name('flat.create');
            Route::post('discount/flat/store', 'discountFlatStore')->name('flat.store');
            Route::get('discount/flat/edit/{id}', 'discountFlatEdit')->name('flat.edit');
            // Batch Discount Management
            Route::get('discount/batch', 'discountBatch')->name('batch');
            Route::get('discount/batch/create', 'discountBatchCreate')->name('batch.create');
            Route::post('discount/batch/store', 'discountBatchStore')->name('batch.store');
        });
