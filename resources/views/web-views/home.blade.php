                ...
                <div
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img
                                src="assets/images/slider/tbanner1.jpg"
                                class="d-block w-100"
                                alt="Makeup Products" />
                        </div>
                        <div class="carousel-item">
                            <img
                                src="assets/images/slider/tbanner2.jpg"
                                class="d-block w-100"
...
<section class="benefit-section py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div
                    class="benefit-box text-center d-flex align-items-center justify-content-center">
                    <div class="me-3">
            ...
            <div class="col-md-3 mb-3">
                <div class="product-card">
                    <a href="#">
                        ...
                        <img
                            src="assets/images/product-img/p1.jpg"
                            alt="Product Image"
                            class="product-img" />
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="category-box">
                        <div class="category-image">
                            <img
                                src="assets/images/category/cat1.jpg"
                                alt="Men's Grooming" />
                        </div>
                ...
                <div class="col-lg-4 mt-4 mt-lg-0">
                    <div class="category-box">
                        <div class="category-image">
                            <img
                                src="assets/images/category/cat2.jpg"
                                alt="Korean Beauty" />
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="combo-img">
                    <img
                        src="assets/images/product-banner/pbanner1.jpg"
                        alt="Combo Image"
                        class="img-fluid" />
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="ingredient-card">
                    <img
                        src="assets/images/product-banner/ni1.jpg"
                ...
                <ul
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="ageing-tab"
                            data-bs-toggle="tab"
                            data-bs-target="#ageing"
                            type="button"
                            role="tab"
                            aria-controls="ageing"
                            aria-selected="false">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingSkincare">
                <button
                    ...
                    data-bs-target="#collapseSkincare"
                    aria-expanded="false"
                    aria-controls="collapseSkincare">
                    Skincare Products
                </button>
            </h2>
            <div
                ...
                aria-labelledby="headingSkincare"
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingMakeup">
                <button
                    ...
                    type="button"
                    data-bs-toggle="collapse"
                    data-bs-target="#collapseMakeup"
                    aria-expanded="false"
                    aria-controls="collapseMakeup">
                    Makeup Products
                </button>
            </h2>
            <div
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingHaircare">
                <button
                    ...
                    type="button"
                    data-bs-toggle="collapse"
                    data-bs-target="#collapseHaircare"
                    aria-expanded="false"
                    aria-controls="collapseHaircare">
                    Haircare Products
                </button>
            </h2>
            <div
                id="collapseHaircare"
                class="accordion-collapse collapse"
                aria-labelledby="headingHaircare"
                data-bs-parent="#searchesAccordion">
                <div class="accordion-body">
                    <ul class="list-unstyled">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingNail">
                <button
                    ...
                    type="button"
                    data-bs-toggle="collapse"
                    data-bs-target="#collapseNail"
                    aria-expanded="false"
                    aria-controls="collapseNail">
                    Nail & Makeup Tools
                </button>
            </h2>
            <div
