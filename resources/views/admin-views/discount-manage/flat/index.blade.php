        ...
        <div class="d-flex justify-content-between mb-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('Flat Discount') }}</li>
                </ol>
            </nav>
            <a href="{{ route('admin.discount.flat.create') }}"
                    ...
                    <div class="card-header">
                        <div class="flex-between row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-between">
                                <div>
                                    <h5>{{ \App\CPU\translate('Flat discount table') }}</h5>
                                </div>
                    ...
                    <div class="card-body" style="padding: 0">
                        <div class="table-responsive">
                            <table id="datatable"
                                ...
                                <tbody>
                                    @foreach ($flatDiscounts as $discount)
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('admin.discount.flat.edit', [$discount->id]) }}">
                                                    <i class="tio-edit"></i> {{ \App\CPU\translate('Edit') }}
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    @if (count($flatDiscounts) == 0)
                                        <tr>
