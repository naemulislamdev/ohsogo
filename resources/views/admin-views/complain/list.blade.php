...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">{{ \App\CPU\translate('Customer') }} {{ \App\CPU\translate('Complain') }}
                    ...
                    <div class="card-header">
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="flex-start col-lg-3 mb-3 mb-lg-0">
                                <h5>{{ \App\CPU\translate('Customer') }} {{ \App\CPU\translate('Complain') }}
                                ...
                                <tbody>
                                    @foreach ($contacts as $k => $contact)
                                        <tr>
                                            ...
                                            <td style="width: 15%">{{ $contact['reasons'] }}</td>
                                            <td style="width: 10%">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <a title="{{ \App\CPU\translate('View') }}" class="btn btn-info btn-sm"
                                                        ...
                                                        href="{{ route('admin.complain.view', $contact->id) }}">
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            toastr.success(
                                '{{ \App\CPU\translate('Contact_deleted_successfully') }}');
                            location.reload();
                        }
                    });
                }
