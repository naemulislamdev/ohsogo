                            ...
                            <table class="display table table-hover "
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">{{ \App\CPU\translate('default') }}
                                                        ...
                                                        @if ($data['code'] != 'en')
                                                            ...
                                                            @if ($data['default'] == true)
                                                                <a class="dropdown-item" href="javascript:"
                                                                    onclick="default_language_delete_alert()">{{ \App\CPU\translate('Delete') }}</a>
                                                            @else
...
@push('script')
    ...
    <script>
        function default_language_delete_alert() {
            toastr.warning(
                '{{ \App\CPU\translate('default language can not be deleted! to delete change the default language first!') }}'
            );
        }
    </script>
@endpush
