...
<script>
    const formFields = ['name', 'phone', 'email', 'address', 'order_note'];
    ...
    // Save values before reload (triggered by shipping method change)
    ...
    // Modify your set_shipping_id function
    function set_shipping_id(id) {
        saveFormDataToLocalStorage(); // Save data before reload
