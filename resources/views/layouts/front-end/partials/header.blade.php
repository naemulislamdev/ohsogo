        ...
        <div class="row py-2 py-lg-3">
                    ...
                    <div class="menu-area">
                        <ul>
                            @foreach ($categoriesFirst3 as $category)
                                <li class="dd-btn1">
                                    <a href="{{ route('collections', $category->slug) }}">
                                                        ...
                                                        <div class="dropdown-menu2">
                                                            ...
                                                            <ul class="w-nav-list level_3">
                                                                @foreach ($sub_subcategories as $sub_subcat)
                                                                    <li class="dd-btn3">
                                                                        <a
                                                                            href="{{ route('collections', $sub_subcat->slug) }}">
                                                                            {{ $sub_subcat->name }}
                                                                        </a>
                                                                    </li>
                                                                @endforeach
            ...
            <div class="col-lg-1">
                <div class="header-icon d-flex justify-content-between align-items-center">
                    <a class="d-none d-lg-block" href="{{ route('login') }}">
                        <i class="fa fa-user-o" aria-hidden="true"></i>
                    </a>
                    {{-- LG Device Cart Offcanvas --}}
...
<div class="mobile-menu">
    ...
    <div class="mm-menu">
        <div class="accordion" id="accordionExample">
            <div class="menu-box">
                <div class="menu-link">
                    <a class="text-uppercase" href="{{ url('/') }}">
                        <i class="fa fa-ptab3 mr-2"></i> Home
                    </a>
                </div>
            </div>
                                        ...
                                        <div class="collapse" id="category{{ $subcat->id }}">
                                            <div class="card card-body scroll-div-dist">
                                                ...
                                                @foreach ($sub_subcategories as $sub_subCat)
                                                    <ul class="mega-item">
                                                        <li class="mega-dd-btn-2">
                                                            <a href="{{ route('collections', $sub_subCat->slug) }}">
                                                                {{ $sub_subCat->name }}
                                                            </a>
                                                        </li>
                                                    </ul>
    ...
    <div class="mt-5 ps-2">
        <a class="border btn text-uppercase" href="{{ route('login') }}">
            Log in <i class="fa fa-user-o" aria-hidden="true"></i>
        </a>
    </div>
</div>
<!--end mobile menu-->
