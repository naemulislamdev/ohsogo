               ...
               <div class="col-lg-3">
                   <nav class="navbar">
                       <div class="menu-area">
                           <ul>
                               <li class="dd-btn1">
                                   <a href="{{ route('page') }}"> Makeup <i class="fa fa-angle-down"></i></a>
                               ...
                               <li class="dd-btn1">
                                   <a href="{{ route('page') }}"> Skin care <i class="fa fa-angle-down"></i></a>
                               ...
                               <li class="dd-btn1">
                                   <a href="{{ route('page') }}"> Hair <i class="fa fa-angle-down"></i></a>
                       ...
                       <a class="d-block d-lg-none" style="margin-left: 20px; margin-top: 12px;"
                           href="{{ url('/') }}">
                           <img style="width: 100px"src="assets/images/logo/logo_High_Res_Mob_x320.avif"
                               alt="logo">
                       </a>
                       {{-- moblile search --}}
               ...
               <div class="col-lg-4">
                   <nav class="navbar">
                       <div class="menu-area">
                           <ul>
                               <li class="dd-btn1">
                                   <a href="{{ route('page') }}"> Essentials <i class="fa fa-angle-down"></i></a>
                               ...
                               <li class="dd-btn1">
                                   <a href="{{ route('page') }}"> Fragrance <i class="fa fa-angle-down"></i></a>
                               ...
                               <li class="dd-btn1">
                                   <a href="{{ route('page') }}"> Baby Care <i class="fa fa-angle-down"></i></a>
   ...
   <div class="mobile-menu">
       ...
       <div class="mm-menu">
           <div class="accordion" id="accordionExample">
               <div class="menu-box">
                   <div class="menu-link">
                       <a href="{{ url('/') }}"><i class="fa fa-ptab3 mr-2"></i> Home</a>
                   </div>
               </div>
               <div class="menu-box">
                   <div class="menu-link" id="headingOne">
                       <a class="mmenu-btn menu-link-active" type="button" data-bs-toggle="collapse"
               ...
               <div class="menu-box">
                   <div class="menu-link" id="headingFive">
                       <a class="mmenu-btn" type="button" data-bs-toggle="collapse"
